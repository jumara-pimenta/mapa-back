...
export class CurrentLocalDTO {
  @ApiProperty()
  @IsString({ message: '[id] O id deve ser do tipo texto.' })
  @IsNotEmpty({ message: '[id] O id deve ser preenchido.' })
  id: string;

  @ApiProperty()
  @IsString({ message: '[message] A mensagem deve ser do tipo texto.' })
  @IsNotEmpty({ message: '[message] A mensagem deve ser preenchida.' })
  message: string;

  @ApiProperty()
  @IsString({ message: '[driverId] O id do motorista deve ser do tipo texto.' })
